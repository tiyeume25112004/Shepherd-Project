...
import core.shepherd_logo as logo
...
ap.add_argument('--cli', help='Run the Command Line version of Shepherd-Project', action='store_true')
ap.add_argument('--pingreq', help='Is it alive, is it dead? | Shepherd-Project', action='store_true')
ap.add_argument('--vulncheck', help='From the infamous Log4j, to heartbleed and a mass port-scan on a public IP - youll know where to hit them where it hurts | Shepherd-Project', action='store_true')
ap.add_argument('--WhoIsRec', help='This will give you public record information about a domains owner, nameservers, etc | Shepherd-Project', action='store_true')
ap.add_argument('--cryptex', help='Utilise the CrypteX package developed by Cythes @ https://github.com/AlexKollar | Shepherd-Project', action='store_true')
ap.add_argument('--p-vpn', help='Connect and Disconnect from ProtonVPN through the P-VPN Feed option | Shepherd-Project', action="store_true")
ap.add_argument('--O-SInt', help='Automatically download the O-SInt toolkit ready for important to your browser | Shepherd-Project', action="store_true")
ap.add_argument('--wp', help='WordPress sites vulnerabilities | Dorkify', action='store_true')
ap.add_argument('--up', help='Find vulnerable Usernames and Passwords | Dorkify', action='store_true')
ap.add_argument('--cam', help='Find vulnerable CCTV cameras | Dorkify', action='store_true')
ap.add_argument('--ftp', help='Find open FTP Servers | Dorkify', action='store_true')
ap.add_argument('-s', '--search', type=str, help='Do a Google search | Dorkify')
ap.add_argument('-b', '--book', type=str, help='Search for a book or author | Dorkify')
ap.add_argument('-mu', '--music', type=str, help='Search for songs or artists | Dorkify')
ap.add_argument('-m', '--maps', type=str, help='Find maps of a city | Dorkify')
ap.add_argument('-w', '--weather', type=str, help='Check weather of a city | Dorkify')
ap.add_argument('-i', '--info', type=str, help='Get Information | Dorkify')
ap.add_argument('-d', '--define', type=str, help='Define a term | Dorkify')
ap.add_argument('-st', '--stocks', type=str, help='Search for Stock of a company with Ticker value | Dorkify')
ap.add_argument('--intitle', type=str, help='Search for a keywords in website title | Dorkify')
ap.add_argument('--inurl', type=str, help='Search for a keywords in website URL | Dorkify')
ap.add_argument('--site', type=str, help='Search for a Site | Dorkify')
ap.add_argument('-v', '--version', help='Version', action="version", version='2.0.1')
args = vars(parser.parse_args())

# Fair warning.
notice = f'''{colors.bcolors.RED}Please read the following information carefully before using this tool:{colors.bcolors.ENDC}
